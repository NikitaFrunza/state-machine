...
bool yasmin_msgs__msg__transition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yasmin_msgs.msg._transition.Transition", full_classname_dest, 38) == 0);
  }
  yasmin_msgs__msg__Transition * ros_message = _ros_message;
  {  // outcome
    ...
    rosidl_runtime_c__String__assign(&ros_message->outcome, PyBytes_AS_STRING(encoded_field));
...
PyObject * yasmin_msgs__msg__transition__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yasmin_msgs.msg._transition");
  ...
  {  // outcome
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->outcome.data,
      strlen(ros_message->outcome.data),
      "replace");
    if (!field) {
      return NULL;
    }
